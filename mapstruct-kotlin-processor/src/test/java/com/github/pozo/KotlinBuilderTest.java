...
class KotlinBuilderTest {
    ...
    TypeElement typeElement(AnnotationMirror... annotationMirror) {
        TypeElement typeElement = mock(TypeElement.class);
        doReturn(Arrays.asList(annotationMirror)).when(typeElement).getAnnotationMirrors();
        return typeElement;
    }

    AnnotationMirror annotationMirror(DeclaredType declaredType) {
    ...
    DeclaredType declaredType(String toString) {
